...
$qry = $pdo->query("INSERT INTO `accounts_collect_entry`( `user_id`, `branch`, `coll_mode`, `bank_id`, `no_of_bills`, `collection_amnt`, `insert_login_id`, `created_on`) VALUES ('$userid','$branch','$cash_type','$bank_id','$no_of_bills','$collected_amnt','$user_id',now())");
