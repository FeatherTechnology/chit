...
<div class="text-right">
    <button type="button" class="btn btn-primary " id="add_enquiry"><span class="fa fa-plus"></span>&nbsp; Add
        Enquiry</button>
    <button type="button" class="btn btn-primary" id="back_btn" style="display:none;"><span
...
<!-- <div id="company_creation_content"> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="chitvalue" name="chitvalue"
                                        placeholder="Enter Chit Value" tabindex="1">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="chitmonth" name="chitmonth"
                                        placeholder="Enter Total Month" tabindex="1">
                                </div>
                            </div>

                        </div>
                        <div class="form-group text-right">
                            <button type="submit" name="submit_enquiry_creation" id="submit_enquiry_creation"
                                class="btn btn-primary" value="Submit" tabindex="9"><span
                                    class="icon-check"></span>&nbsp;Submit</button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Enter Customer Name" tabindex="8">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="mobilenumber" name="mobilenumber"
                                        ...
                                        onKeyPress="if(this.value.length==10) return false;" tabindex="10">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="place" name="place"
                                        placeholder="Enter Costumer Place" tabindex="11">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
